...
namespace VFEInsectoids
{
    public class ScenPart_SquadArriveMethod : ScenPart_PlayerPawnsArriveMethod
    {
        ...
        public override void GenerateIntoMap(Map map)
        {
            ...
            GenStep_InsectGen.Generate(map, layoutDef, 250);
        ...
        public static void MakeHellPod(IntVec3 c, Map map, ActiveTransporterInfo info)
        {
            var activeDropPod = (ActiveTransporter)ThingMaker.MakeThing(VFEI_DefOf.VFEI_HellpodActiveDropPod);
